...
| 技能 | 来源 | 编辑策略 | 分配角色 |
|---|---|---|---|
| `drawio-skill` | `legacy-migrated` | `managed` | `drawio-expert` |
| `drawio-session-editing` | `legacy-migrated` | `managed` | `drawio-expert` |
...
| References | `.opencode/references/` / `opencode.json.references` | 0 个别名 |
...
|---|---|---|---|---|---|---|---|---|---|---|
| `drawio-expert` | 较高 | `guided` | role-autonomy | ask | allow | ask | allow | ask | ask | ask |
...
- 本地：`.opencode/plugins/drawio-runtime-hooks.js`
