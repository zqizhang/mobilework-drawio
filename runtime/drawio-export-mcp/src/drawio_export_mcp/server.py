...
from .service import error_response, export_drawio_file
...
# ---------------------------------------------------------------------------
def _error(error_code: str, message: str, remediation: str, **extra) -> dict:
    return error_response(error_code, message, remediation, **extra)
...
def drawio_export(
    ...
    """
    return export_drawio_file(
        input_path,
        format,
        path_security=_get_path_security(),
        export_client=_get_export_client(),
